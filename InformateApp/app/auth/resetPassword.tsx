        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.subtitle}>
                    Jangan khawatir. Masukkan email Anda dan kami akan membantu meresetnya.
                </Text>
            </View>
...
const styles = StyleSheet.create({
    ...
    inputContainer: { flexDirection: "row", alignItems: "center", borderWidth: 1, borderColor: "#E8E8E8", borderRadius: 12, paddingHorizontal: 15, marginBottom: 20, height: 55, backgroundColor: "#FAFAFA" },
    icon: { marginRight: 10 },
    input: { flex: 1, height: "100%", fontSize: 16, color: "#333" },
    button: { backgroundColor: "#007BFF", height: 55, borderRadius: 12, justifyContent: "center", alignItems: "center", shadowColor: "#007BFF", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 5, elevation: 4 },
    buttonDisabled: { backgroundColor: "#A5C9FF", shadowOpacity: 0, elevation: 0 },
